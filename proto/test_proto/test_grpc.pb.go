...
type MyServiceClient interface {
	MyMethod(ctx context.Context, in *TestRequest, opts ...grpc.CallOption) (*TestResponse, error)
}
...
func (c *myServiceClient) MyMethod(ctx context.Context, in *TestRequest, opts ...grpc.CallOption) (*TestResponse, error) {
	out := new(TestResponse)
	err := c.cc.Invoke(ctx, "/test_proto.MyService/MyMethod", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type MyServiceServer interface {
	MyMethod(context.Context, *TestRequest) (*TestResponse, error)
...
func (UnimplementedMyServiceServer) MyMethod(context.Context, *TestRequest) (*TestResponse, error) {
...
func _MyService_MyMethod_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/test_proto.MyService/MyMethod",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(MyServiceServer).MyMethod(ctx, req.(*TestRequest))
	}
...
var MyService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "test_proto.MyService",
